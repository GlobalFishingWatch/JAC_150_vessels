...
load_or_install_libraries( c("tidyverse" , "bigrquery" ,"devtools", "DBI","glue", "lubridate", "here", "sf", "extrafont", "patchwork", "terra", "rgeos") )
...
# save output in outputs directory 
ggsave(here::here("outputs", "figures", "LRYY715_name_map_v3.png"), width = 10, height = 7)
