...
outside_AIS <- filter(voi_ais, ssvid %in% c(outside_chn_ais$ssvid))
...
# still lots of CHN transmissions. Drop them with a lat/lon subset to make sure we dont still have
