...
# set plot limits for Pacific 
bounding_np <- transform_box(xlim = c(130, 190),
                             #xlim = c(-170, 130),
                           #xlim = c(130, -170),
                          ylim = c(35, 50),
                          output_crs = best_proj)
...
seg_summary %>% filter(overlapping_seg)
...
date_start <- as.POSIXct('2023-02-01')
...
bounding_atlantic <- transform_box(xlim = c(-60, -60.8),
                          ylim = c(-44.75, -46),
                          output_crs = best_proj)
...
map_dif
ggsave(here::here("outputs", "figures", "Atlantic_highres_150402944_01_08Feb2023.png"))
